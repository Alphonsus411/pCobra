...
def build_holobit_runtime_lines() -> list[str]:
    return [
        ...
        ';; Runtime Holobit Wasm: si el host no implementa pcobra:holobit, la instanciación falla explícitamente con el nombre del import faltante (sin fallback silencioso)',
