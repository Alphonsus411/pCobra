...
assert SUPPORTED_TARGETS == EXPECTED_CANONICAL_TARGETS
assert OFFICIAL_TRANSPILATION_TARGETS_IN_TESTS == EXPECTED_CANONICAL_TARGETS
...
assert VERIFICATION_EXECUTABLE_TARGETS == OFFICIAL_RUNTIME_TARGETS
...
assert set(BEST_EFFORT_INTERNAL_RUNTIME_TARGETS).isdisjoint(TRANSPILATION_ONLY_TARGETS)
assert (
    set(OFFICIAL_RUNTIME_TARGETS)
    | set(BEST_EFFORT_INTERNAL_RUNTIME_TARGETS)
